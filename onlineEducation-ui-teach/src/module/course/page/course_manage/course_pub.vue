        ...
        <el-card class="box-card">
          ...
          <div class="text item">
            ...
            <div v-else-if="course.status == '202003'">
              状态：已下线
              <br/><br/>
              <span><a :href="'http://www.gly-online-education.com/course/detail/'+this.courseid+'.html'"
...
<script>
  /* eslint-disable indent,spaced-comment,space-before-function-paren,semi,quotes,padded-blocks,no-unused-vars */
