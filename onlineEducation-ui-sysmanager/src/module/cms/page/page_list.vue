<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column prop="pageAliase" label="别名" width="100">
      </el-table-column>
      <el-table-column prop="pageType" label="页面类型" width="140">
      </el-table-column>
      <el-table-column prop="pageWebPath" label="访问路径" width="250">
      </el-table-column>
      <el-table-column prop="pagePhysicalPath" label="物理路径" width="270">
      </el-table-column>
      <el-table-column prop="pageCreateTime" label="创建时间" width="260">
      </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //页面预览
      preview(pageId) {
        window.open("http://www.gly-online-education.com/cms/preview/" + pageId)
      },
      //頁面發佈
      postPage (id) {
